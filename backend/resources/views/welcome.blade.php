                ...
                <div class="grid grid-cols-1">
                    <a href="/api/notes"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Sticky Notes API
                                Backend</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                This is an APIs to Sticky Notes Application <br />
                                Copyright: Mukhtasar to Test Fullstack Developer @Redcomm
                            </p>
                        </div>
